...
class _ChildInfoState extends State<ChildInfo> {
  ...
  Column _buildRegisterHeader() {
    return Column(
      ...
      children: [
        ...
        Text("Step 2 of 4", style: RegisterStyles.textSmall),
        Text("Child Info", style: RegisterStyles.title),
        SizedBox(height: 5.0),
        Text(
  ...
  Widget navigate(BuildContext context) {
    Future.delayed(Duration(milliseconds: 0), () {
      Navigator.of(context).pushReplacementNamed(Routes.register_growth_info);
    });
    _store.dispose();
    return Container();
  }

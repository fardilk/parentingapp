...
class OtpSuccessModal extends StatelessWidget {
  const OtpSuccessModal({super.key, required this.onTapSuccess});
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        Padding(
          ...
          child: Text(
            "Your OTP already correct. Let’s move to the next step",
            textAlign: TextAlign.center,
            style: TextStyle(
              fontFamily: FontFamily.avenirLTStd,
              fontSize: 12,
        ...
        Spacer(),
        RoundedButtonWidget(
            buttonText: "Selanjutnya", onPressed: () => onTapSuccess())
      ]),
    );
  }
}

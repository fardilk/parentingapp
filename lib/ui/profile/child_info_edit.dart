...
class ChildInfoEdit extends StatefulWidget {
  const ChildInfoEdit({super.key});

  @override
  State<ChildInfoEdit> createState() => _ChildInfoEditState();
}

class _ChildInfoEditState extends State<ChildInfoEdit> {
  ...
  final ChildrenStore _store = getIt<ChildrenStore>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: BackAppBar(title: Text("Edit Children")),
      body: Stack(
        children: [
          Column(
  ...
  Widget navigate(BuildContext context) {
    Future.delayed(Duration(milliseconds: 0), () {
      showSuccessModal(
              context, "Children Info Updated", "Children info updated")
          .then((value) {

...
class EditVaccinationScreen extends StatefulWidget {
  const EditVaccinationScreen({super.key});
...
class _EditVaccinationScreenState extends State<EditVaccinationScreen> {
  ...
  void initState() {
    ...
    _vaccineBrandController.text = _vaccineStore.vaccineBrand;
    _vaccineNameController.text = _vaccineStore.vaccineName;
    _locationNameController.text = _vaccineStore.locationName;
    _doctorNameController.text = _vaccineStore.doctorName;
    _batchNumberController.text = _vaccineStore.batchNumber;
    _notesController.text = _vaccineStore.notes;

    if (_vaccineStore.vaccinationDate != null) {
      _vaccinationDateController.text =
          DateFormat("d MMMM yyyy").format(_vaccineStore.vaccinationDate!);
    }
  }
  ...
  BackAppBar _buildAppBar() {
    return BackAppBar(
      title: Text(_vaccineStore.vaccineName),
      actions: [
        Observer(
          builder: (context) {
            if (_vaccineStore.vaccineId != 0) {
    ...
    return showMaterialModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return ActionSuccessModal(
            description:
                "Data vaksin telah berhasil diubah dalam database kamu",
            title: "Edit Vaksin Berhasil!",
          );
        });
  }
